...
//! This is intended for use with the `pezkuwi-overseer` crate.
//!
...
pub enum CandidateBackingMessage {
	...
	Second {
		...
		/// scheduling_parent of the descriptor directly: <https://github.com/pezkuwichain/pezkuwi-DKS/issues/10883#issue-3844123650>
...
pub enum PvfExecKind {
	...
	Approval,
	/// For backing requests from system teyrchains. With relay parent hash
...
pub enum CollatorProtocolMessage {
	...
	DistributeCollation {
		...
		/// The result sender should be informed when at least one teyrchain validator seconded the
...
pub enum AvailabilityDistributionMessage {
	...
	FetchPoV {
		...
		/// The id of the teyrchain that produced this PoV.
...
pub enum RuntimeApiRequest {
	...
	/// Get the candidate pending availability for a particular teyrchain by teyrchain / core
	/// index
	...
	/// Get the backing constraints for a particular teyrchain.
	/// `V12`
	...
	/// Get the maximum relay parent session age allowed for teyrchain blocks.
	/// `V16`
...
/// Request introduction of a seconded candidate into the prospective teyrchains subsystem.
...
/// in the prospective teyrchains subsystem.
///
...
/// A collection of ancestor candidates of a teyrchain.
...
pub enum ProspectiveTeyrchainsMessage {
	...
	/// Inform the Prospective Teyrchains Subsystem that a previously introduced candidate
	...
	/// teyrchain, under the given relay chain leaf hash.
	///
	...
	GetBackableCandidates {
		...
		leaf: Hash,
		/// The teyrchain to get backable candidates for.
		para_id: ParaId,
	...
	/// part of some fragment chain or which prospective-teyrchains predicted will become part of
	/// some fragment chain).
