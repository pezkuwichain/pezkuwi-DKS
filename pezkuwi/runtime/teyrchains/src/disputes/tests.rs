...
fn test_check_signature_approval_multiple_candidates_coalesce_limit() {
	...
	let session = 0;
	let candidate_hash = CandidateHash(pezsp_core::H256::repeat_byte(1));
	let other_1 = CandidateHash(pezsp_core::H256::repeat_byte(2));
	let other_2 = CandidateHash(pezsp_core::H256::repeat_byte(3));
	let unrelated = CandidateHash(pezsp_core::H256::repeat_byte(9));
