...
fn minimum_relay_parent_number() {
	new_test_ext(MockGenesisConfig::default()).execute_with(|| {
		...
		assert_eq!(Pezpallet::<Test>::get_minimum_relay_parent_number(), Some(10));
		...
		assert_eq!(Pezpallet::<Test>::get_minimum_relay_parent_number(), Some(20));
		...
		assert_eq!(Pezpallet::<Test>::get_minimum_relay_parent_number(), Some(40));
	});
}
...
fn new_block_inserts_relay_parent_and_scheduling_parent() {
	new_test_ext(MockGenesisConfig::default()).execute_with(|| {
		...
		let info = Pezpallet::<Test>::get_relay_parent_info(session, hash)
...
fn new_block_prunes_old_sessions_relay_parents() {
	new_test_ext(MockGenesisConfig::default()).execute_with(|| {
		...
		for i in 0..3u32 {
			assert!(
				Pezpallet::<Test>::get_relay_parent_info(0, Hash::repeat_byte(i as u8)).is_some()
			);
			assert!(Pezpallet::<Test>::get_relay_parent_info(1, Hash::repeat_byte((10 + i) as u8))
				.is_some());
			assert!(Pezpallet::<Test>::get_relay_parent_info(2, Hash::repeat_byte((20 + i) as u8))
				.is_some());
		}
		assert_eq!(OldestRelayParentSession::<Test>::get(), 0);
		...
		assert!(Pezpallet::<Test>::get_relay_parent_info(3, Hash::repeat_byte(30)).is_some());
		...
		assert!(Pezpallet::<Test>::get_relay_parent_info(3, Hash::repeat_byte(30)).is_some());
		assert!(Pezpallet::<Test>::get_relay_parent_info(5, Hash::repeat_byte(50)).is_some());
...
fn new_block_max_age_zero_keeps_only_current_session() {
	new_test_ext(MockGenesisConfig::default()).execute_with(|| {
		...
		assert!(Pezpallet::<Test>::get_relay_parent_info(0, Hash::repeat_byte(0)).is_some());
		...
		assert!(Pezpallet::<Test>::get_relay_parent_info(0, Hash::repeat_byte(0)).is_none());
		assert!(Pezpallet::<Test>::get_relay_parent_info(1, Hash::repeat_byte(1)).is_some());
		assert_eq!(OldestRelayParentSession::<Test>::get(), 1);
	});
}
...
fn new_block_increasing_max_age() {
	new_test_ext(MockGenesisConfig::default()).execute_with(|| {
		...
		assert_eq!(OldestRelayParentSession::<Test>::get(), 3);
		assert!(Pezpallet::<Test>::get_relay_parent_info(2, Hash::repeat_byte(2)).is_none());
		assert!(Pezpallet::<Test>::get_relay_parent_info(3, Hash::repeat_byte(3)).is_some());
		...
		assert!(Pezpallet::<Test>::get_relay_parent_info(0, Hash::repeat_byte(0)).is_none());
		assert!(Pezpallet::<Test>::get_relay_parent_info(1, Hash::repeat_byte(1)).is_none());
		assert!(Pezpallet::<Test>::get_relay_parent_info(2, Hash::repeat_byte(2)).is_none());

		// But sessions 3 and 4 are still there.
		assert!(Pezpallet::<Test>::get_relay_parent_info(3, Hash::repeat_byte(3)).is_some());
		// The original session 4 entry (Hash::repeat_byte(4)) and the new one both survive.
		assert!(Pezpallet::<Test>::get_relay_parent_info(4, Hash::repeat_byte(4)).is_some());
		assert!(Pezpallet::<Test>::get_relay_parent_info(4, Hash::repeat_byte(5)).is_some());
	});
}
...
fn new_block_decreasing_max_age_prunes_multiple_sessions() {
	new_test_ext(MockGenesisConfig::default()).execute_with(|| {
		...
		for session in 0..5u32 {
			assert!(Pezpallet::<Test>::get_relay_parent_info(
				session,
				Hash::repeat_byte(session as u8)
			)
			.is_some());
		...
		assert!(Pezpallet::<Test>::get_relay_parent_info(4, Hash::repeat_byte(4)).is_some());
		assert!(Pezpallet::<Test>::get_relay_parent_info(5, Hash::repeat_byte(5)).is_some());
	});
}
...
fn cross_session_relay_parents_are_accessible() {
	new_test_ext(MockGenesisConfig::default()).execute_with(|| {
		...
		for (session, hash) in hashes.iter().enumerate() {
			let info = Pezpallet::<Test>::get_relay_parent_info(session as u32, *hash)
		...
		assert!(Pezpallet::<Test>::get_relay_parent_info(1, hashes[0]).is_none());
		// Wrong hash returns None.
		assert!(Pezpallet::<Test>::get_relay_parent_info(0, Hash::repeat_byte(99)).is_none());
	});
}
...
fn session_change_clears_scheduling_parents_but_not_relay_parents() {
	new_test_ext(MockGenesisConfig::default()).execute_with(|| {
		...
		assert!(Pezpallet::<Test>::get_relay_parent_info(0, Hash::repeat_byte(1)).is_some());
		assert!(Pezpallet::<Test>::get_relay_parent_info(0, Hash::repeat_byte(2)).is_some());
	});
}
