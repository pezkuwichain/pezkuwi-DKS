...
pub struct TeyrchainTemporarySlot<AccountId, LeasePeriod> {
...
pub mod pezpallet {
	...
	pub type TemporarySlots<T: Config> = StorageMap<
		...
		Twox64Concat,
		ParaId,
		TeyrchainTemporarySlot<T::AccountId, LeasePeriodOf<T>>,
		OptionQuery,
	>;
...
mod tests {
	...
	fn assign_perm_slot_fails_when_not_parathread() {
		new_test_ext().execute_with(|| {
			...
			assert_ok!(TestRegistrar::<Test>::make_teyrchain(ParaId::from(1_u32)));
	...
	fn assign_perm_slot_succeeds_for_parathread() {
		new_test_ext().execute_with(|| {
			...
			while block < 9 {
				...
				assert_eq!(TestRegistrar::<Test>::is_teyrchain(ParaId::from(1_u32)), true);
	...
	fn assign_temp_slot_succeeds_for_multiple_parathreads() {
		new_test_ext().execute_with(|| {
			...
			for n in 1..=5 {
				...
				assert_eq!(TestRegistrar::<Test>::is_teyrchain(ParaId::from(0)), true);
				assert_eq!(TestRegistrar::<Test>::is_teyrchain(ParaId::from(1_u32)), false);
				assert_eq!(TestRegistrar::<Test>::is_teyrchain(ParaId::from(2_u32)), true);
				assert_eq!(TestRegistrar::<Test>::is_teyrchain(ParaId::from(3_u32)), false);
				assert_eq!(TestRegistrar::<Test>::is_teyrchain(ParaId::from(4_u32)), false);
				assert_eq!(TestRegistrar::<Test>::is_teyrchain(ParaId::from(5_u32)), false);
			...
			for n in 6..=11 {
				System::run_to_block::<AllPalletsWithSystem>(n);
				assert_eq!(TestRegistrar::<Test>::is_teyrchain(ParaId::from(0)), false);
				assert_eq!(TestRegistrar::<Test>::is_teyrchain(ParaId::from(1_u32)), true);
				assert_eq!(TestRegistrar::<Test>::is_teyrchain(ParaId::from(2_u32)), false);
				assert_eq!(TestRegistrar::<Test>::is_teyrchain(ParaId::from(3_u32)), true);
				assert_eq!(TestRegistrar::<Test>::is_teyrchain(ParaId::from(4_u32)), false);
				assert_eq!(TestRegistrar::<Test>::is_teyrchain(ParaId::from(5_u32)), false);
				assert_eq!(assigned_slots::ActiveTemporarySlotCount::<Test>::get(), 2);
			}
			...
			for n in 12..=17 {
				...
				assert_eq!(TestRegistrar::<Test>::is_teyrchain(ParaId::from(2_u32)), false);
				assert_eq!(TestRegistrar::<Test>::is_teyrchain(ParaId::from(3_u32)), false);
				assert_eq!(TestRegistrar::<Test>::is_teyrchain(ParaId::from(4_u32)), true);
				assert_eq!(TestRegistrar::<Test>::is_teyrchain(ParaId::from(5_u32)), true);
				assert_eq!(assigned_slots::ActiveTemporarySlotCount::<Test>::get(), 2);
			}
