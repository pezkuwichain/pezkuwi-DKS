...
// --output=./pezkuwi/runtime/pezkuwichain/src/weights/runtime_common_coretime.rs
...
impl<T: pezframe_system::Config> runtime_common::coretime::WeightInfo for WeightInfo<T> {
