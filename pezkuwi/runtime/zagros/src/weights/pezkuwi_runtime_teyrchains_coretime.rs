...
impl<T: pezframe_system::Config> pezkuwi_runtime_teyrchains::coretime::WeightInfo for WeightInfo<T> {
	...
	fn request_revenue_at() -> Weight {
		...
		//  Measured:  `3012`
		//  Estimated: `6477`
		// Minimum execution time: 145_411_000 picoseconds.
		Weight::from_parts(240_187_000, 0)
	...
	fn assign_core(s: u32, ) -> Weight {
		...
		Weight::from_parts(39_919_764, 0)
			.saturating_add(Weight::from_parts(0, 1575))
			// Standard Error: 1_235
			.saturating_add(Weight::from_parts(16_470, 0).saturating_mul(s.into()))
	...
	fn credit_account() -> Weight {
		...
		Weight::from_parts(29_534_000, 0)
