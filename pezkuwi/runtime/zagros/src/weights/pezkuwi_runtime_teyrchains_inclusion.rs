...
impl<T: pezframe_system::Config> pezkuwi_runtime_teyrchains::inclusion::WeightInfo for WeightInfo<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		//  Estimated: `36283 + c * (15998 ±1_206) + h * (6143 ±1_500) + u * (19447 ±655)`
		// Minimum execution time: 543_032_000 picoseconds.
		Weight::from_parts(65_945_845, 0)
			.saturating_add(Weight::from_parts(0, 36283))
			// Standard Error: 2_327_921
			.saturating_add(Weight::from_parts(277_016_058, 0).saturating_mul(u.into()))
			// Standard Error: 2_327_921
			.saturating_add(Weight::from_parts(285_993_996, 0).saturating_mul(h.into()))
			// Standard Error: 3_857_643
			.saturating_add(Weight::from_parts(159_308_611, 0).saturating_mul(c.into()))
