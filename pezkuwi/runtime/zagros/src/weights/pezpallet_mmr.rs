...
impl<T: pezframe_system::Config> pezpallet_mmr::WeightInfo for WeightInfo<T> {
	...
	fn on_initialize(x: u32, ) -> Weight {
		...
		//  Measured:  `1071074`
		//  Estimated: `3608923 + x * (8 ±1)`
		// Minimum execution time: 13_637_670_000 picoseconds.
		Weight::from_parts(18_430_071_077, 0)
			.saturating_add(Weight::from_parts(0, 3608923))
			// Standard Error: 134_418
			.saturating_add(Weight::from_parts(175_084, 0).saturating_mul(x.into()))
