...
fn pezkuwichain_genesis_config() -> serde_json::Value {
	...
	let validator_funding: u128 = zagros_runtime_constants::currency::HEZ_VALIDATOR_FUNDING;
	...
	let checking_account_seed: u128 =
		HEZ_FOUNDER_ALLOCATION + zagros_runtime_constants::currency::HEZ_VALIDATOR_FUNDING;
