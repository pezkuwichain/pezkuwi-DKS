...
//! DATE: 2026-02-25, STEPS: `50`, REPEAT: `20`, LOW RANGE: `[]`, HIGH RANGE: `[]`
//! WORST CASE MAP SIZE: `1000000`
//! HOSTNAME: `0c4a18954d47`, CPU: `Intel(R) Xeon(R) CPU @ 2.60GHz`
...
impl<T: pezframe_system::Config> pezkuwi_runtime_teyrchains::on_demand::WeightInfo for WeightInfo<T> {
	...
	fn place_order_keep_alive() -> Weight {
		...
		//  Measured:  `80233`
		//  Estimated: `81718`
		// Minimum execution time: 188_568_000 picoseconds.
		Weight::from_parts(197_304_000, 0)
			.saturating_add(Weight::from_parts(0, 81718))
	...
	fn place_order_allow_death() -> Weight {
		...
		//  Measured:  `80233`
		//  Estimated: `81718`
		// Minimum execution time: 189_124_000 picoseconds.
		Weight::from_parts(196_866_000, 0)
			.saturating_add(Weight::from_parts(0, 81718))
			.saturating_add(T::DbWeight::get().reads(3))
			.saturating_add(T::DbWeight::get().writes(3))
	}
	...
	fn place_order_with_credits() -> Weight {
		...
		//  Measured:  `80267`
		//  Estimated: `83732`
		// Minimum execution time: 164_470_000 picoseconds.
		Weight::from_parts(170_751_000, 0)
			.saturating_add(Weight::from_parts(0, 83732))
			.saturating_add(T::DbWeight::get().reads(3))
			.saturating_add(T::DbWeight::get().writes(3))
	}
}
