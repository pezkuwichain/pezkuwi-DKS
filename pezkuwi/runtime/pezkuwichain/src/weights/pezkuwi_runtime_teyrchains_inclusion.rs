...
impl<T: pezframe_system::Config> pezkuwi_runtime_teyrchains::inclusion::WeightInfo for WeightInfo<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		//  Measured:  `831 + c * (15992 ±0) + h * (92 ±0) + u * (32955 ±0)`
		//  Estimated: `36283 + c * (15998 ±1_844) + h * (6143 ±1_500) + u * (19447 ±1_500)`
		// Minimum execution time: 580_644_000 picoseconds.
		Weight::from_parts(81_294_252, 0)
			.saturating_add(Weight::from_parts(0, 36283))
			// Standard Error: 2_398_244
			.saturating_add(Weight::from_parts(292_157_615, 0).saturating_mul(u.into()))
			// Standard Error: 2_398_244
			.saturating_add(Weight::from_parts(306_994_921, 0).saturating_mul(h.into()))
			// Standard Error: 3_974_178
			.saturating_add(Weight::from_parts(152_212_450, 0).saturating_mul(c.into()))
			...
			.saturating_add(Weight::from_parts(0, 15998).saturating_mul(c.into()))
			.saturating_add(Weight::from_parts(0, 6143).saturating_mul(h.into()))
			.saturating_add(Weight::from_parts(0, 19447).saturating_mul(u.into()))
	}
}
