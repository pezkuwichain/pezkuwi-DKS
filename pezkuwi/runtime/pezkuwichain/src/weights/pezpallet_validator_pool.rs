...
impl<T: pezframe_system::Config> pezpallet_validator_pool::WeightInfo for WeightInfo<T> {
	...
	fn leave_validator_pool() -> Weight {
		...
		Weight::from_parts(52_528_000, 0)
			.saturating_add(Weight::from_parts(0, 3546))
	...
	fn force_new_era(p: u32, ) -> Weight {
		...
		// Minimum execution time: 113_421_000 picoseconds.
		Weight::from_parts(96_878_216, 0)
			.saturating_add(Weight::from_parts(0, 3546))
			// Standard Error: 69_533
			.saturating_add(Weight::from_parts(23_720_374, 0).saturating_mul(p.into()))
