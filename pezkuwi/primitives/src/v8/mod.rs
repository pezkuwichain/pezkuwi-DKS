...
/// appropriate.
#[derive(Eq, Ord, PartialEq, PartialOrd, Copy, Clone, Encode, Decode, DecodeWithMemTracking, TypeInfo, Debug)]
...
#[derive(Encode, Decode, DecodeWithMemTracking, Default, PartialOrd, Ord, Eq, PartialEq, Clone, Copy, TypeInfo, Debug)]
#[cfg_attr(feature = "std", derive(Hash))]
