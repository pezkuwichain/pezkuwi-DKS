...
use pezpallet_accumulate_and_forward::Forwarder;
...
parameter_types! {
	...
	pub static UniversalLocation: InteriorLocation = (ByGenesis([0; 32]), Teyrchain(42)).into();
	pub static AssetHubLocation: Location = Location::new(1, [Teyrchain(1000)]);
...
fn new_test_ext(source: AccountId, balance: u128) -> pezsp_io::TestExternalities {
