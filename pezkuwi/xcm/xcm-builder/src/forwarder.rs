...
//! XCM adapters for the accumulate-and-forward pezpallet.
//!
...
/// XCM adapter that implements [`pezpallet_accumulate_and_forward::Forwarder`] for AccountId32-type
...
impl<XcmConfig, Dest, NativeAsset, StagingLocation, AccountId, Balance>
	pezpallet_accumulate_and_forward::Forwarder<AccountId, Balance>
