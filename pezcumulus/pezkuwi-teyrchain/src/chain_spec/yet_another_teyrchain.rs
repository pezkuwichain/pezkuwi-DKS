...
use pezsp_core::{hex2array, sr25519::Pair as SrPair, Pair};
...
pub fn yet_another_teyrchain_config(
	...
	GenericChainSpec::builder(
		yet_another_teyrchain_runtime::WASM_BINARY
			.expect("WASM binary was not built, please build it!"),
		Extensions::new_with_relay_chain(relay.into()),
	)
	.with_name("Yet Another Teyrchain")
	.with_id("yet_another_teyrchain")
