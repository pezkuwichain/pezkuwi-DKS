...
/// [`VersionedMigration`](pezframe_support::migrations::VersionedMigration), that is performed only
/// when the on-chain version is 6.
pub type MigrateV6ToV7<T> = pezframe_support::migrations::VersionedMigration<
	6,
	7,
