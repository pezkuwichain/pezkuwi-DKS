...
/// Weight functions needed for `pezcumulus_pallet_weight_reclaim`.
pub trait WeightInfo {
	fn storage_weight_reclaim() -> Weight;
}

/// Weights for `pezcumulus_pallet_weight_reclaim` using the Bizinikiwi node and recommended hardware.
#[allow(dead_code)]
