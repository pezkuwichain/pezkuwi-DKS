...
//! of teyrchain blocks ready to submit to the relay chain, as well as some basic implementations.
...
pub trait ConsensusHook {
	/// This hook is called partway through the `set_validation_data` inherent in teyrchain-system.
	///
