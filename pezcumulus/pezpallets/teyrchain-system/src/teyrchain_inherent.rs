...
/// A message that was received by the teyrchain.
...
/// The basic inherent data that is passed by the collator to the teyrchain runtime.
...
/// The messages that are passed by the collator to the teyrchain runtime as part of the
/// inherent data.
#[derive(
	codec::Encode,
	codec::Decode,
