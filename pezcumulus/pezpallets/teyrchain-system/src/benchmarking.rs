...
use pezsp_runtime::traits::{BlakeTwo256, DispatchTransaction, Dispatchable};
...
mod benchmarks {
	...
	fn block_weight_tx_extension_max_weight() -> Result<(), BenchmarkError> {
		...
		pezframe_system::Pezpallet::<T>::note_inherents_applied();

		pezframe_system::Pezpallet::<T>::set_extrinsic_index(1);
