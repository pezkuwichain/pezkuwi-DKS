...
/// Fee budget for one cross-chain alias attempt. The macro splits it in half: one half pays
/// for local execution and delivery on the sending chain, the other is carried to the remote
/// leg.
///
