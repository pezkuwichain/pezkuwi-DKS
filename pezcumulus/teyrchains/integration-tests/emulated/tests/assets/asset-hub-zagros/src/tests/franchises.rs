...
fn no_subject_is_decided_by_two_different_electorates() {
	...
	use zagros_system_emulated_network::{
		people_zagros_emulated_chain::people_zagros_runtime, zagros_emulated_chain::zagros_runtime,
	};
	...
	let economic = names::<asset_hub_zagros_runtime::governance::TracksInfo>();
	let state = names::<people_zagros_runtime::governance::TracksInfo>();
	let relay = names::<zagros_runtime::governance::TracksInfo>();
...
fn the_relay_key_mirror_matches() {
	...
	let ours = zagros_runtime::SessionKeys {
	...
	let mirrored = people_zagros_runtime::people::RelaySessionKeys::decode(&mut &ours[..]);
	...
	assert_eq!(
		people_zagros_runtime::people::RelaySessionKeys::key_ids(),
		zagros_runtime::SessionKeys::key_ids(),
