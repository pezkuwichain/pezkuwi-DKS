...
impl<T: pezframe_system::Config> pezpallet_trust::WeightInfo for WeightInfo<T> {
	...
	fn force_recalculate_trust_score() -> Weight {
		...
		Weight::from_parts(34_353_000, 0)
	...
	fn update_all_trust_scores() -> Weight {
		...
		Weight::from_parts(63_970_000, 0)
	...
	fn periodic_trust_score_update() -> Weight {
		...
		Weight::from_parts(77_415_000, 0)
			.saturating_add(Weight::from_parts(0, 6038))
