...
impl<T: pezframe_system::Config> pezpallet_election_provider_multi_block::unsigned::WeightInfo for WeightInfo<T> {
	...
	fn validate_unsigned() -> Weight {
		...
		Weight::from_parts(51_796_000, 0)
	...
	/// Storage: `MultiBlockElectionVerifier::QueuedSolutionY` (r:0 w:32)
	...
	fn submit_unsigned() -> Weight {
		...
		//  Measured:  `904`
		//  Estimated: `81094`
		// Minimum execution time: 612_271_000 picoseconds.
		Weight::from_parts(913_602_000, 0)
			.saturating_add(Weight::from_parts(0, 81094))
