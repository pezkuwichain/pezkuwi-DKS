...
impl<T: pezframe_system::Config> pezpallet_pez_treasury::WeightInfo for WeightInfo<T> {
	...
	fn force_genesis_distribution() -> Weight {
		...
		//  Measured:  `557`
		//  Estimated: `8817`
		// Minimum execution time: 97_301_000 picoseconds.
		Weight::from_parts(146_262_000, 0)
	...
	fn release_monthly_funds() -> Weight {
		...
		//  Measured:  `769`
		//  Estimated: `8817`
		// Minimum execution time: 150_922_000 picoseconds.
		Weight::from_parts(226_352_000, 0)
			.saturating_add(Weight::from_parts(0, 8817))
