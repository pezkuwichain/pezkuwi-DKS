...
// --pezpallet=pezpallet_token_wrapper
...
/// Weight functions for `pezpallet_token_wrapper`.
pub struct WeightInfo<T>(PhantomData<T>);
impl<T: pezframe_system::Config> pezpallet_token_wrapper::WeightInfo for WeightInfo<T> {
	...
	fn wrap() -> Weight {
		...
		Weight::from_parts(169_506_000, 0)
	...
	fn unwrap() -> Weight {
		...
		//  Measured:  `781`
		//  Estimated: `3675`
		// Minimum execution time: 152_794_000 picoseconds.
		Weight::from_parts(235_899_000, 0)
			.saturating_add(Weight::from_parts(0, 3675))
