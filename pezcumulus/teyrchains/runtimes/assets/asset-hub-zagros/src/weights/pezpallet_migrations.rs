...
impl<T: pezframe_system::Config> pezpallet_migrations::WeightInfo for WeightInfo<T> {
	...
	fn clear_historic(n: u32, ) -> Weight {
		...
		Weight::from_parts(53_864_081, 0)
			.saturating_add(Weight::from_parts(0, 3834))
			// Standard Error: 12_149
			.saturating_add(Weight::from_parts(2_707_859, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(1))
	...
	fn reset_pezpallet_migration(n: u32, ) -> Weight {
		...
		Weight::from_parts(5_680_000, 0)
			...
			.saturating_add(Weight::from_parts(1_717_993, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(n.into())))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(n.into())))
