...
//! Autogenerated weights for `pezsnowbridge_pezpallet_system_v2`
//!
...
// --pezpallet=pezsnowbridge_pezpallet_system_v2
...
/// Weight functions for `pezsnowbridge_pezpallet_system_v2`.
...
impl<T: pezframe_system::Config> pezsnowbridge_pezpallet_system_v2::WeightInfo for WeightInfo<T> {
	...
	fn register_token() -> Weight {
		...
		//  Measured:  `111`
		//  Estimated: `4115`
		// Minimum execution time: 63_358_000 picoseconds.
		Weight::from_parts(100_496_000, 0)
	...
	fn upgrade() -> Weight {
		...
		Weight::from_parts(84_688_000, 0)
	...
	fn set_operating_mode() -> Weight {
		...
		Weight::from_parts(74_108_000, 0)
			.saturating_add(Weight::from_parts(0, 3601))
			.saturating_add(T::DbWeight::get().reads(3))
			.saturating_add(T::DbWeight::get().writes(3))
	}
