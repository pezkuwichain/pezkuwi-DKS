...
pub mod locations {
	use pezframe_support::parameter_types;
	pub use rococo_runtime_constants::system_teyrchain::{AssetHubParaId, PeopleParaId};
	use xcm::latest::prelude::{Location, Teyrchain};

	parameter_types! {
		pub AssetHubLocation: Location = Location::new(1, Teyrchain(rococo_runtime_constants::system_teyrchain::ASSET_HUB_ID));
		pub PeopleLocation: Location = Location::new(1, Teyrchain(rococo_runtime_constants::system_teyrchain::PEOPLE_ID));
	}
}
