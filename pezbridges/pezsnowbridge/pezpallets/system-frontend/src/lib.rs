...
pub mod pezpallet {
	...
	pub trait Config: pezframe_system::Config {
		...
		/// InteriorLocation of this pezpallet.
		...
		/// Weights for pezpallet dispatchables
	...
	#[pezpallet::storage]
	#[pezpallet::getter(fn export_operating_mode)]
	...
	impl<T: Config> ExportPausedQuery for Pezpallet<T> {
		fn is_paused() -> bool {
