...
//! Autogenerated weights for `pezsnowbridge-pezpallet-outbound-queue`
//!
...
// --pezpallet=pezsnowbridge-pezpallet-outbound-queue
// --extrinsic=*
// --execution=wasm
...
/// Weight functions needed for `pezsnowbridge-pezpallet-outbound-queue`.
