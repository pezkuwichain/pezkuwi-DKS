...
pub mod pezpallet {
	...
	#[pezpallet::storage]
	#[pezpallet::getter(fn validators_root)]
	...
	impl<T: Config> Pezpallet<T> {
		...
		#[pezpallet::weight(T::WeightInfo::force_checkpoint())]
		#[transactional]
		/// Used for pezpallet initialization and light client resetting. Needs to be called by
		/// the root origin.
