...
impl NetworkNode {
	...
	pub async fn rpc(&self) -> Result<RpcClient, pezkuwi_subxt::Error> {
	...
	pub async fn client<Config: pezkuwi_subxt::Config>(
		&self,
	) -> Result<OnlineClient<Config>, pezkuwi_subxt::Error> {
	...
	pub async fn try_client<Config: pezkuwi_subxt::Config>(
		&self,
	) -> Result<OnlineClient<Config>, pezkuwi_subxt::Error> {
		get_client_from_url(&self.ws_uri).await
	}
