...
A list of known [SS58](https://docs.substrate.io/reference/address-formats/) account types as an enum, typically used by the Polkadot, Dicle or Substrate ecosystems.
