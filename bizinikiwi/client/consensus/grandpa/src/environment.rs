...
use pezsp_consensus::SelectChain as SelectChainT;
...
use pezsp_runtime::traits::{Block as BlockT, Header as HeaderT, NumberFor, Zero};
	...
	Client: HeaderMetadata<Block, Error = pezsp_blockchain::Error>,
{
	...
	let tree_route_res = pezsp_blockchain::tree_route(&**client, block, base);
