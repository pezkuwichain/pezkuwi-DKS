...
//! gossiping protocols that are Bizinikiwi-related and outside of the scope of libp2p.
//!
//! # Usage
//!
...
pub struct NotifsHandler {
	...
	// TODO: this should be safe to remove, see https://github.com/pezkuwichain/pezkuwi-DKS/issues/6350
