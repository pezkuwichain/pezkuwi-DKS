...
//! Implementation of the [`DevApiServer`] trait providing debug utilities for Bizinikiwi based
//! blockchains.
...
use pezsc_rpc_api::{check_if_safe, dev::error::Error};
...
pub use pezsc_rpc_api::dev::{BlockStats, DevApiServer};
