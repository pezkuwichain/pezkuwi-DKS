...
//! Bizinikiwi statement store API.
...
pub use pezsc_rpc_api::statement::{error::Error, StatementApiServer};
...
pub trait StatementStoreApi:
	pezsp_statement_store::StatementStore + pezsc_statement_store::StatementStoreSubscriptionApi
{
}
impl<T> StatementStoreApi for T where
	T: pezsp_statement_store::StatementStore + pezsc_statement_store::StatementStoreSubscriptionApi
{
}
/// Statement store API
