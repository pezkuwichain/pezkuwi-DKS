...
use pezsp_statement_store::{StatementSource, SubmitResult};
use std::sync::Arc;

/// Statement store API
pub struct StatementStore {
	store: Arc<dyn pezsp_statement_store::StatementStore>,
}

impl StatementStore {
	/// Create new instance of Offchain API.
	pub fn new(store: Arc<dyn pezsp_statement_store::StatementStore>) -> Self {
