...
use pezsc_network_types::kad::{Key, PeerRecord, Record};
...
/// Wrapper for [`AuthorityDiscoveryApi`](pezsp_authority_discovery::AuthorityDiscoveryApi). Can be
...
/// underlying Bizinikiwi networking. Using this trait abstraction instead of
/// `pezsc_network::NetworkService` directly is necessary to unit test [`Worker`].
