...
impl<Block: BlockT> HeaderBackend<Block> for TestApi {
	fn header(
		&self,
		_hash: Block::Hash,
	) -> std::result::Result<Option<Block::Header>, pezsp_blockchain::Error> {
		Ok(None)
	}
	...
	fn status(
		&self,
		_hash: Block::Hash,
	) -> std::result::Result<pezsc_client_api::blockchain::BlockStatus, pezsp_blockchain::Error> {
		Ok(pezsc_client_api::blockchain::BlockStatus::Unknown)
	}

	fn number(
		&self,
		_hash: Block::Hash,
	) -> std::result::Result<Option<NumberFor<Block>>, pezsp_blockchain::Error> {
		Ok(None)
	}
	...
	) -> std::result::Result<Option<Block::Hash>, pezsp_blockchain::Error> {
		Ok(None)
	}
}
...
struct DhtValueFoundTester {
	...
	pub remote_authority_public: pezsp_core::sr25519::Public,
	...
	pub local_worker: Option<
		Worker<
			...
			pezsp_runtime::generic::Block<
				...
				bizinikiwi_test_runtime_client::runtime::Extrinsic,
			>,
