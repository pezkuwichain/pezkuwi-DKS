...
use pezsc_transaction_pool_api::{TransactionStatus, TransactionStatusStream, TxIndex};
...
/// term here means that it can be exposed to [`pezsc_transaction_pool_api::TransactionPool`] API
/// client e.g. over RPC.)
///
