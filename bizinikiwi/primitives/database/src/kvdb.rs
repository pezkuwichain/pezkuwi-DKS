...
/// A wrapper around `kvdb::Database` that implements `pezsp_database::Database` trait
...
/// Wrap RocksDb database into a trait object that implements `pezsp_database::Database`
