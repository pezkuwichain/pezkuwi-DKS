...
a Bizinikiwi runtime and a Bizinikiwi node. For a native runtime the interface maps to a direct function call of the
...
associated type
[`FFIType`](https:/docs.rs/pezsp-runtime-interface/latest/sp_runtime_interface/trait.RIType.html#associatedtype.FFIType) is
...
[table](https:/docs.rs/pezsp-runtime-interface/latest/sp_runtime_interface/#ffi-type-and-conversion). The FFI function
...
[`RIType::FFIType`](https:/docs.rs/pezsp-runtime-interface/latest/sp_runtime_interface/trait.RIType.html#associatedtype.FFIType).
...
[`PassBy`](https://docs.rs/pezsp-runtime-interface/latest/sp_runtime_interface/pass_by#PassBy) trait and strategies that
...
[`#[runtime_interface]`](https://docs.rs/pezsp-runtime-interface/latest/sp_runtime_interface/attr.runtime_interface.html).
