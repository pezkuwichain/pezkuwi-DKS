...
use pezsp_runtime_interface_test_wasm::{test_api::HostFunctions, wasm_binary_unwrap};
use pezsp_runtime_interface_test_wasm_deprecated::wasm_binary_unwrap as wasm_binary_deprecated_unwrap;

use pezsc_executor_common::{runtime_blob::RuntimeBlob, wasm_runtime::AllocationStats};
use pezsp_wasm_interface::{ExtendedHostFunctions, HostFunctions as HostFunctionsT};
...
type TestExternalities = pezsp_state_machine::TestExternalities<pezsp_runtime::traits::BlakeTwo256>;
...
fn call_wasm_method_with_result<HF: HostFunctionsT>(
	...
	let executor = pezsc_executor::WasmExecutor::<
		ExtendedHostFunctions<pezsp_io::BizinikiwiHostFunctions, HF>,
	>::builder()
	.build();
