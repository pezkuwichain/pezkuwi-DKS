...
///
/// ```
/// # use pezsp_arithmetic::{traits::EnsureSub, ArithmeticError};
...
///
/// ```
/// # use pezsp_arithmetic::{traits::EnsureSubAssign, ArithmeticError};
/// # fn foo() -> Result<(), ArithmeticError> {
/// # let mut my_value: i32 = 1;
/// # let other_value: i32 = 1;
...
mod ensure {
	...
	pub trait EnsureAdd: EnsureAddAssign {
		...
		///
		/// ```
		/// use pezsp_arithmetic::traits::EnsureAdd;
		///
		/// let a: i32 = 10;
		/// let b: i32 = 20;
		///
		...
		///
		/// ```
		/// use pezsp_arithmetic::{traits::EnsureAdd, ArithmeticError};
		///
	...
	pub trait EnsureSub: EnsureSubAssign {
		...
		///
		/// ```
		/// use pezsp_arithmetic::traits::EnsureSub;
		///
		/// let a: i32 = 10;
		/// let b: i32 = 20;
		///
	...
	pub trait EnsureMul: EnsureMulAssign {
		...
		///
		/// ```
		/// use pezsp_arithmetic::traits::EnsureMul;
		///
		/// let a: i32 = 10;
		/// let b: i32 = 20;
		///
		...
		///
		/// ```
		/// use pezsp_arithmetic::{traits::EnsureMul, ArithmeticError};
		///
		/// fn overflow() -> Result<(), ArithmeticError> {
	...
	pub trait EnsureDiv: EnsureDivAssign {
		...
		///
		/// ```
		/// use pezsp_arithmetic::traits::EnsureDiv;
		///
		/// let a: i32 = 20;
		/// let b: i32 = 10;
		///
		...
		///
		/// ```
		/// use pezsp_arithmetic::{traits::EnsureDiv, ArithmeticError};
		///
	...
	///
	/// ```
	/// use pezsp_arithmetic::{traits::ensure_pow, ArithmeticError};
	///
	/// fn overflow() -> Result<(), ArithmeticError> {
	///     ensure_pow(2u64, 64)?;
	///     Ok(())
	...
	pub trait EnsureAddAssign: CheckedAdd + PartialOrd + Zero {
		...
		///
		/// ```
		/// use pezsp_arithmetic::traits::EnsureAddAssign;
		///
		/// let mut a: i32 = 10;
		/// let b: i32 = 20;
		///
		...
		///
		/// ```
		/// use pezsp_arithmetic::{traits::EnsureAddAssign, ArithmeticError};
		///
		/// fn overflow() -> Result<(), ArithmeticError> {
		///     let mut max = u32::MAX;
	...
	pub trait EnsureSubAssign: CheckedSub + PartialOrd + Zero {
		...
		///
		/// ```
		/// use pezsp_arithmetic::traits::EnsureSubAssign;
		///
		/// let mut a: i32 = 10;
		/// let b: i32 = 20;
		///
	...
	pub trait EnsureMulAssign: CheckedMul + PartialOrd + Zero {
		...
		///
		/// ```
		/// use pezsp_arithmetic::traits::EnsureMulAssign;
		///
		/// let mut a: i32 = 10;
		/// let b: i32 = 20;
		///
		...
		///
		/// ```
		/// use pezsp_arithmetic::{traits::EnsureMulAssign, ArithmeticError};
		///
		/// fn overflow() -> Result<(), ArithmeticError> {
		///     let mut max = u32::MAX;
	...
	pub trait EnsureDivAssign: CheckedDiv + PartialOrd + Zero {
		...
		///
		/// ```
		/// use pezsp_arithmetic::traits::EnsureDivAssign;
		///
		/// let mut a: i32 = 20;
		/// let b: i32 = 10;
		///
		...
		///
		/// ```
		/// use pezsp_arithmetic::{traits::EnsureDivAssign, ArithmeticError, FixedI64};
		///
		/// fn extrinsic_zero() -> Result<(), ArithmeticError> {
		///     let mut one = 1;
	...
	pub trait EnsureFixedPointNumber: FixedPointNumber {
		...
		///
		/// ```
		/// use pezsp_arithmetic::{traits::EnsureFixedPointNumber, ArithmeticError, FixedI64};
		///
		/// fn extrinsic_zero() -> Result<(), ArithmeticError> {
	...
	pub trait EnsureFrom<T: PartialOrd + Zero>: TryFrom<T> + PartialOrd + Zero {
		...
		///
		/// ```
		/// use pezsp_arithmetic::{traits::EnsureFrom, ArithmeticError};
		///
		/// fn overflow() -> Result<(), ArithmeticError> {
	...
	pub trait EnsureInto<T: PartialOrd + Zero>: TryInto<T> + PartialOrd + Zero {
		...
		///
		/// ```
		/// use pezsp_arithmetic::{traits::EnsureInto, ArithmeticError};
		///
		/// fn overflow() -> Result<(), ArithmeticError> {
