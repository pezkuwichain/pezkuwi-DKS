...
pub mod pezpallet {
	...
	impl<T: Config<I>, I: 'static> Pezpallet<T, I> {
		...
		pub fn as_rank(
			o: &<T::RuntimeOrigin as pezframe_support::traits::OriginTrait>::PalletsOrigin,
		) -> Option<u16> {
			use pezframe_support::traits::CallerTrait;
	...
	impl<T: Config<I>, I: 'static> Pezpallet<T, I> {
		...
		fn try_state_members() -> Result<(), pezsp_runtime::TryRuntimeError> {
		...
		fn try_state_index() -> Result<(), pezsp_runtime::TryRuntimeError> {
