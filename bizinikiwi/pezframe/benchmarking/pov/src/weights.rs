...
//! Autogenerated weights for `pezframe_benchmarking_pezpallet_pov`
//!
...
// --pezpallet=pezframe_benchmarking_pezpallet_pov
...
/// Weight functions needed for `pezframe_benchmarking_pezpallet_pov`.
...
/// Weights for `pezframe_benchmarking_pezpallet_pov` using the Bizinikiwi node and recommended hardware.
