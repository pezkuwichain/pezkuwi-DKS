...
use pezsp_io::hashing::{blake2_128, blake2_256, twox_128, twox_256, twox_64};
use pezsp_metadata_ir as metadata_ir;

// This trait must be kept coherent with pezframe-support-procedural HasherKind usage
