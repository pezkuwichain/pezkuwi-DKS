...
/// [`StorageMap`](pezframe_support::storage::types::StorageMap) with a key of type `(k1, k2)`.
...
{
	fn pezpallet_prefix() -> &'static [u8] {
		<Self as crate::storage::generator::StorageDoubleMap<Key1, Key2, Value>>::pezpallet_prefix()
	}
	fn storage_prefix() -> &'static [u8] {
	...
	MaxValues: Get<Option<u32>>,
{
	...
	pub fn remove_prefix<KArg1>(k1: KArg1, limit: Option<u32>) -> pezsp_io::KillStorageResult
	where
