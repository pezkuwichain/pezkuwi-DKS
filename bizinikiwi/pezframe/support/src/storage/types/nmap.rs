...
{
	fn pezpallet_prefix() -> &'static [u8] {
		<Self as crate::storage::generator::StorageNMap<Key, Value>>::pezpallet_prefix()
	}
	fn storage_prefix() -> &'static [u8] {
	...
	MaxValues: Get<Option<u32>>,
{
	...
	pub fn remove_prefix<KP>(partial_key: KP, limit: Option<u32>) -> pezsp_io::KillStorageResult
	where
		Key: HasKeyPrefix<KP>,
	{
		#[allow(deprecated)]
...
mod test {
	...
	use pezsp_metadata_ir::{StorageEntryModifierIR, StorageHasherIR};
