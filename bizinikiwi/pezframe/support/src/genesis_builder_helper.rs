...
//! Helper functions for implementing [`pezsp_genesis_builder::GenesisBuilder`] for runtimes.
//!
//! Provides common logic. For more info refer to [`pezsp_genesis_builder::GenesisBuilder`].
...
/// more info refer to [`pezsp_genesis_builder::GenesisBuilder::build_state`].
...
/// to [`pezsp_genesis_builder::GenesisBuilder::get_preset`].
