...
use pezsp_runtime::{traits::Member, DispatchError};
...
impl<T, P: Polling<T>> pezsp_runtime::traits::Get<u32> for ClassCountOf<P, T> {
	fn get() -> u32 {
...
/// NoOp polling is required if pezpallet-referenda functionality not needed.
