...
///
/// ```rust
/// # use pezframe_support::traits::{EnsureOriginEqualOrHigherPrivilege, PrivilegeCmp, EnsureOrigin as _};
/// # use pezsp_runtime::traits::{parameter_types, Get};
...
/// Methods available on `pezframe_system::Config::RuntimeOrigin`.
pub trait OriginTrait: Sized {
	...
	/// Reset origin filters to default one, i.e `pezframe_system::1fig::BaseCallFilter`.
	...
	/// Create with system none origin and `pezframe_system::Config::BaseCallFilter`.
	fn none() -> Self;

	/// Create with system root origin and `pezframe_system::Config::BaseCallFilter`.
	fn root() -> Self;

	/// Create with system signed origin and `pezframe_system::Config::BaseCallFilter`.
