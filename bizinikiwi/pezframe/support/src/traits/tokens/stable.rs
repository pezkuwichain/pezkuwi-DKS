...
//! Traits for stablecoin inter-pezpallet communication.

/// Trait exposing the PSM pezpallet's reserved capacity to other pezpallets.
///
/// Implemented by the PSM pezpallet, used by the Vaults pezpallet to account for
