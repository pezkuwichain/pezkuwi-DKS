...
//! Traits for managing information attached to pezpallets and their constituents.
...
/// Provide information about a bunch of pezpallets.
pub trait PalletsInfoAccess {
	/// The number of pezpallets' information that this type represents.
	///
	...
	/// All of the pezpallets' information that this type represents.
