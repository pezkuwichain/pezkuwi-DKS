...
//! Autogenerated weights for `pezpallet_democracy`
//!
...
/// Weight functions needed for `pezpallet_democracy`.
...
/// Weights for `pezpallet_democracy` using the Bizinikiwi node and recommended hardware.
