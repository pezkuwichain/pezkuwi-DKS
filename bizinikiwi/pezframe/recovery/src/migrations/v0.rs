...
//! V0 storage definitions for the recovery pezpallet.
//!
...
use pezframe::{
	deps::{
		pezsp_io::hashing::blake2_256,
		pezsp_runtime::traits::{One, TrailingZeroInput},
	},
...
pub trait MigrationConfig: crate::pezpallet::Config {
...
pub type BalanceOf<T> = <<T as MigrationConfig>::Currency as Currency<
	<T as pezframe_system::Config>::AccountId,
>>::Balance;

/// Block number type from provider.
pub type BlockNumberFromProviderOf<T> =
	<<T as crate::pezpallet::Config>::BlockNumberProvider as BlockNumberProvider>::BlockNumber;

/// Friends bounded vec type.
pub type FriendsOf<T> = BoundedVec<
	<T as pezframe_system::Config>::AccountId,
	<T as crate::pezpallet::Config>::MaxFriendsPerConfig,
>;
