...
// benchmark
// pezpallet
// --runtime=target/production/wbuild/pez-kitchensink-runtime/pez_kitchensink_runtime.compact.compressed.wasm
// --template=bizinikiwi/.maintain/pezframe-weight-template.hbs
// --output=bizinikiwi/pezframe/recovery/src/weights.rs
// --pezpallet=pezpallet-recovery
// --extrinsic=
