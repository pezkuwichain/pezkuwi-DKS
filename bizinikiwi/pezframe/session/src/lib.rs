...
//!
//! fn validators<T: pezpallet_session::Config>() -> Vec<<T as pezpallet_session::Config>::ValidatorId> {
//! 	pezpallet_session::Validators::<T>::get()
//! }
//! # fn main(){}
//! ```
//!
//! ## Related Pallets
//!
//! - [Staking](../pezpallet_staking/index.html)
...
impl<AId> SessionHandler<AId> for TestSessionHandler {
	const KEY_TYPE_IDS: &'static [KeyTypeId] = &[pezsp_runtime::key_types::DUMMY];
...
pub mod pezpallet {
	...
	pub trait Config: pezframe_system::Config {
		...
		/// [`pezsp_runtime::traits::ConvertInto`].
		///
