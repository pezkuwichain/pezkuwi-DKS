...
//!
//! See the [`pezframe_tokens`] reference docs for more information about the place of the
...
//! ## Related Modules
//!
//! * [`System`](../pezframe_system/index.html)
//! * [`Support`](../pezframe_support/index.html)
//!
...
pub mod pezpallet {
	...
	pub trait Config<I: 'static = ()>: pezframe_system::Config {
		...
		///
		/// This type includes the `From<Self::AssetId>` bound, since tightly coupled pezpallets may
	...
	impl<T: Config<I>, I: 'static> Pezpallet<T, I> {
		...
		#[pezpallet::weight(T::WeightInfo::set_reserves(reserves.len() as u32))]
		pub fn set_reserves(
			origin: OriginFor<T>,
			id: T::AssetIdParameter,
	...
	pub fn do_try_state() -> Result<(), pezsp_runtime::TryRuntimeError> {
		...
		for (asset_id, details) in Asset::<T, I>::iter() {
			...
			if details.accounts != calculated_accounts {
				// Legacy error in Dicle Asset Hub that needs to be cleaned up.
				log::error!(
