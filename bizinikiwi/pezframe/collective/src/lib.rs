...
///
/// These types implement [Convert](pezsp_runtime::traits::Convert) trait and can be used with types
/// like [HoldConsideration](`pezframe_support::traits::fungible::HoldConsideration`) implementing
/// [Consideration](`pezframe_support::traits::Consideration`) trait.
///
/// ### Example:
///
...
pub mod deposit {
	...
	use pezsp_core::Get;
	use pezsp_runtime::{traits::Convert, FixedPointNumber, FixedU128, Saturating};
	...
	where
		Deposit: Get<Balance>,
		Balance: pezframe_support::traits::tokens::Balance,
	{
...
pub mod pezpallet {
	...
	pub trait Config<I: 'static = ()>: pezframe_system::Config {
		...
		/// for a proposer.
		type DisapproveOrigin: EnsureOrigin<<Self as pezframe_system::Config>::RuntimeOrigin>;
		...
		type KillOrigin: EnsureOrigin<<Self as pezframe_system::Config>::RuntimeOrigin>;
	...
	for<'a> &'a O::PalletsOrigin: TryInto<&'a RawOrigin<AccountId, I>>,
{
	...
	fn try_successful_origin() -> Result<O, ()> {
		let zero_account_id =
			AccountId::decode(&mut pezsp_runtime::traits::TrailingZeroInput::zeroes())
