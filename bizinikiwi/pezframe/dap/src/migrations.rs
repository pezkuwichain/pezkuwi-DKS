...
//! DAP pezpallet migrations.

use super::*;
use crate::weights::WeightInfo;
use pezframe_support::traits::{Time, UncheckedOnRuntimeUpgrade};
...
pub type MigrateV1ToV2<T, P, B, M> = pezframe_support::migrations::VersionedMigration<
	1,
	2,
	InnerMigrateV1ToV2<T, P, B, M>,
	pezpallet::Pezpallet<T>,
	...
	for InnerMigrateV1ToV2<T, P, B, M>
{
	fn on_runtime_upgrade() -> pezframe_support::weights::Weight {
		...
		let minted = pezpallet::Pezpallet::<T>::mint_and_distribute(elapsed);
	...
	fn post_upgrade(state: alloc::vec::Vec<u8>) -> Result<(), pezsp_runtime::TryRuntimeError> {
		...
		pezpallet::Pezpallet::<T>::do_try_state()?;
