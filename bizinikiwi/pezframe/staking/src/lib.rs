...
/// <https://github.com/paritytech/bizinikiwi/issues/14749>.
#[derive(
	PartialEqNoBound,
	EqNoBound,
	CloneNoBound,
...
///
/// This is needed because `Staking` sets the `ValidatorIdOf` of the `pezpallet_session::Config`
...
impl<T: Config> SessionInterface<<T as pezframe_system::Config>::AccountId> for T
where
...
///     type IdentificationOf = pezpallet_staking::DefaultExposureOf<Self>
/// }
/// ```
...
///     type IdentificationOf = pezpallet_staking::UnitIdentificationOf<Self>
/// }
/// ```
...
/// A mock benchmarking config for pezpallet-staking.
///
...
impl BenchmarkingConfig for TestBenchmarkingConfig {
	type MaxValidators = pezframe_support::traits::ConstU32<100>;
	type MaxNominators = pezframe_support::traits::ConstU32<100>;
}
