...
//! Stress tests pezpallet-message-queue. Defines its own runtime config to use larger constants for
...
//!
//! ```sh
//! RUST_LOG=info cargo test -p pezpallet-message-queue --profile testnet -- --ignored
//! ```
...
use crate as pezpallet_message_queue;
