...
pub enum Phase<T: crate::Config> {
	...
	///
	/// This value should be interpreted after `on_initialize`/`on_poll` of this pezpallet has already
	/// been called.
	Snapshot(PageIndex),
...
/// Slim interface for the parent pezpallet to be able to inspect the state of the signed pezpallet.
///
