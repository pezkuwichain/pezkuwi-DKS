...
//! Exposes types that can be used to extend `pezpallet_revive` with additional functionality.
//!
...
pub(crate) const EVM_REVERT: [u8; 5] = pezsp_core::hex2array!("60006000fd");
...
pub trait Precompile {
	...
	/// 	Providing your own storage and using pezpallet_revive to collect deposits is also possible,
	/// though.
