...
use pezpallet_revive_proc_macro::define_env;
use pezpallet_revive_uapi::{CallFlags, ReturnErrorCode, ReturnFlags};
use pezsp_core::U256;
use pezsp_io::hashing::keccak_256;
use pezsp_runtime::{DispatchError, SaturatedConversion};
...
impl<T: Config> ContractBlob<T> {
	...
	pub fn prepare_call<E: Ext<T = T>>(
		...
		let gas_limit_polkavm: polkavm::Gas = runtime.ext().pezframe_meter_mut().sync_to_executor();
...
impl<T: Config> ContractBlob<T> {
	...
	pub fn from_pvm_code(code: Vec<u8>, owner: AccountIdOf<T>) -> Result<Self, DispatchError> {
		...
		let code_hash = H256(pezsp_io::hashing::keccak_256(&code));
...
pub mod env {
	...
	/// See [`pezpallet_revive_uapi::HostFn::set_storage`]
	#[mutating]
	fn set_storage(
		&mut self,
		memory: &mut M,
	...
	/// See [`pezpallet_revive_uapi::HostFn::set_storage_or_clear`].
	#[mutating]
	...
	/// See [`pezpallet_revive_uapi::HostFn::get_storage`]
	fn get_storage(
		&mut self,
		memory: &mut M,
		flags: u32,
	...
	/// See [`pezpallet_revive_uapi::HostFn::get_storage_or_zero`].
	...
	/// See [`pezpallet_revive_uapi::HostFn::call`].
	fn call(
		&mut self,
		memory: &mut M,
	...
	/// Make a call to another contract.
	/// See [`pezpallet_revive_uapi::HostFn::call_evm`].
	fn call_evm(
		&mut self,
		memory: &mut M,
		flags: u32,
	...
	/// See [`pezpallet_revive_uapi::HostFn::delegate_call`].
	fn delegate_call(
		&mut self,
		memory: &mut M,
		flags_and_callee: u64,
	...
	/// See [`pezpallet_revive_uapi::HostFn::delegate_call_evm`].
	...
	/// See [`pezpallet_revive_uapi::HostFn::instantiate`].
	#[mutating]
	fn instantiate(
		&mut self,
		memory: &mut M,
	...
	/// See [`pezpallet_revive_uapi::HostFn::call_data_size `].
	...
	/// See [`pezpallet_revive_uapi::HostFn::call_data_copy`].
	fn call_data_copy(
		&mut self,
		memory: &mut M,
		out_ptr: u32,
	...
	/// See [`pezpallet_revive_uapi::HostFn::call_data_load`].
	fn call_data_load(
		&mut self,
		memory: &mut M,
		out_ptr: u32,
	...
	/// See [`pezpallet_revive_uapi::HostFn::return_value`].
	fn seal_return(
		&mut self,
		memory: &mut M,
		flags: u32,
	...
	/// See [`pezpallet_revive_uapi::HostFn::caller`].
	...
	/// See [`pezpallet_revive_uapi::HostFn::origin`].
	...
	/// See [`pezpallet_revive_uapi::HostFn::code_hash`].
	...
	/// See [`pezpallet_revive_uapi::HostFn::code_size`].
	...
	/// See [`pezpallet_revive_uapi::HostFn::address`].
	...
	/// See [`pezpallet_revive_uapi::HostFn::get_immutable_data`].
	...
	/// See [`pezpallet_revive_uapi::HostFn::set_immutable_data`].
	...
	/// See [`pezpallet_revive_uapi::HostFn::balance`].
	...
	/// See [`pezpallet_revive_uapi::HostFn::chain_id`].
	...
	/// See [`pezpallet_revive_uapi::HostFn::gas_limit`].
	...
	/// See [`pezpallet_revive_uapi::HostFn::value_transferred`].
	...
	/// See [`pezpallet_revive_uapi::HostFn::gas_price`].
	...
	/// See [`pezpallet_revive_uapi::HostFn::base_fee`].
	...
	/// See [`pezpallet_revive_uapi::HostFn::now`].
	...
	/// See [pezpallet_revive_uapi::HostFn::deposit_event]
	#[mutating]
	fn deposit_event(
		&mut self,
		memory: &mut M,
	...
	/// See [`pezpallet_revive_uapi::HostFn::block_number`].
	...
	/// See [`pezpallet_revive_uapi::HostFn::block_hash`].
	fn block_hash(
		&mut self,
		memory: &mut M,
	...
	/// See [`pezpallet_revive_uapi::HostFn::block_author`].
	...
	/// See [`pezpallet_revive_uapi::HostFn::hash_keccak_256`].
	fn hash_keccak_256(
		&mut self,
		memory: &mut M,
		input_ptr: u32,
	...
	/// See [`pezpallet_revive_uapi::HostFn::return_data_size`].
	...
	/// See [`pezpallet_revive_uapi::HostFn::return_data_copy`].
	fn return_data_copy(
		&mut self,
		memory: &mut M,
		out_ptr: u32,
	...
	///
	/// See [`pezpallet_revive_uapi::HostFn::gas_left`].
	...
	///
	/// See [`pezpallet_revive_uapi::HostFn::consume_all_gas`].
	fn consume_all_gas(&mut self, memory: &mut M) -> Result<(), TrapReason> {
		self.ext.pezframe_meter_mut().consume_all_weight();
	...
	/// See [`pezpallet_revive_uapi::HostFn::terminate`].
	#[mutating]
