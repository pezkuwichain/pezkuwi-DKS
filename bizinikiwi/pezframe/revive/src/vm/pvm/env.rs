...
pub mod env {
	...
	/// teyrchain has unstable functions disabled.
	...
	/// See [`pezpallet_revive_uapi::HostFn::set_storage_v2`]
	#[stable]
	#[mutating]
	fn set_storage(
		&mut self,
	...
	/// See [`pezpallet_revive_uapi::HostFn::return_data`].
	#[stable]
	fn return_data_copy(
		&mut self,
		memory: &mut M,
	...
	/// See [`pezpallet_revive_uapi::HostFn::ecdsa_to_eth_address`].
	...
	/// See [`pezpallet_revive_uapi::HostFn::set_code_hash`].
	///
	...
	/// See [`pezpallet_revive_uapi::HostFn::sr25519_verify`].
	fn sr25519_verify(
		&mut self,
		memory: &mut M,
		signature_ptr: u32,
