...
/// `prevrandao`, a randomness value from the beacon chain. In Bizinikiwi pezpallet-revive
...
impl<T: Config> ContractBlob<T> {
	...
	/// the deposit to, so the caller passes the pezpallet's own account as a
