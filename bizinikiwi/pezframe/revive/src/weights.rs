...
//! Autogenerated weights for `pezpallet_revive`
//!
...
/// Weight functions needed for `pezpallet_revive`.
...
/// Weights for `pezpallet_revive` using the Bizinikiwi node and recommended hardware.
