...
//!Types, and traits to integrate pezpallet-revive with EVM.
#![warn(missing_docs)]
...
type OnChargeTransactionBalanceOf<T> = <<T as pezpallet_transaction_payment::Config>::OnChargeTransaction as pezpallet_transaction_payment::OnChargeTransaction<T>>::Balance;
