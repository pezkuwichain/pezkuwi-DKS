...
impl<T: Config> Deposit<T> for () {
	...
	/// [`deactivated`](pezframe_support::traits::fungible::Unbalanced::deactivate) so that
	...
	RefundPercent: Get<Perbill>,
{
	...
	/// ED is [`deactivated`](pezframe_support::traits::fungible::Unbalanced::deactivate) so it stays
	...
	/// pezpallet-assets' `reducible_balance` treats any frozen amount as untouchable, regardless
