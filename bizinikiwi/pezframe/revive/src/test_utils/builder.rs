...
use crate::{
	...
	InstantiateReturnValue, OriginFor, Pezpallet, U256, Weight, address::AddressMapper,
...
builder!(
	...
	pub fn instantiate(origin: OriginFor<T>, code_hash: pezsp_core::H256) -> Self {
		Self {
			origin,
			value: 0u32.into(),
			weight_limit: WEIGHT_LIMIT,
