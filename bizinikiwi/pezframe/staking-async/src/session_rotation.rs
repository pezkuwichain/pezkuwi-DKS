...
use crate::*;
use alloc::vec::Vec;
use pezframe_election_provider_support::{BoundedSupportsOf, ElectionProvider, PageIndex};
...
impl<T: Config> Eras<T> {
	...
	pub(crate) fn era_fully_present(era: EraIndex) -> Result<(), pezsp_runtime::TryRuntimeError> {
