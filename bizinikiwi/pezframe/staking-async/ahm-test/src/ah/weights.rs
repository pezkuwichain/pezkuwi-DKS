...
use pezframe::deps::pezframe_system;
use pezframe_election_provider_support::Weight;
use pezframe_support::traits::Get;
use pezpallet_election_provider_multi_block::weights::traits::{
...
impl pezpallet_election_provider_multi_block::WeightInfo for MultiBlockElectionWeightInfo {
	fn admin_set() -> Weight {
		unreachable!()
	}
...
impl pezpallet_election_provider_multi_block_verifier::WeightInfo for MultiBlockElectionWeightInfo {
...
impl pezpallet_election_provider_multi_block_signed::WeightInfo for MultiBlockElectionWeightInfo {
	fn bail() -> Weight {
		unreachable!()
	}
...
impl pezpallet_election_provider_multi_block_unsigned::WeightInfo for MultiBlockElectionWeightInfo {
...
impl pezpallet_staking_async::WeightInfo for StakingAsyncWeightInfo {
	fn bond() -> Weight {
		unreachable!()
	}
	...
	fn process_offence_queue() -> Weight {
		let max_block =
			<ah::mock::BlockWeights as Get<pezframe_system::limits::BlockWeights>>::get().max_block;
		// Reserve headroom for DAP drip weight which also runs in on_initialize.
		max_block.saturating_sub(<() as pezpallet_dap::WeightInfo>::drip_issuance())
	}
