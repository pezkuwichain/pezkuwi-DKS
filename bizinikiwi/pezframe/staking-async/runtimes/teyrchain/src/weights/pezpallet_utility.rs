...
//! EXECUTION: ``, WASM-EXECUTION: `Compiled`, CHAIN: `Some("asset-hub-next-zagros-dev")`, DB CACHE: 1024
...
// --output=./teyrchains/runtimes/assets/asset-hub-next-zagros/src/weights/
