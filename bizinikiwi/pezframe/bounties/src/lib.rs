...
//! # Bounties Module ( pezpallet-bounties )
//!
//! ## Bounty
//!
...
type PositiveImbalanceOf<T, I = ()> = pezpallet_treasury::PositiveImbalanceOf<T, I>;
...
type BlockNumberFor<T, I = ()> =
	<<T as pezpallet_treasury::Config<I>>::BlockNumberProvider as BlockNumberProvider>::BlockNumber;
		...
		pub fn approve_bounty(
			...
			Bounties::<T, I>::try_mutate_exists(bounty_id, |maybe_bounty| -> DispatchResult {
				let bounty = maybe_bounty.as_mut().ok_or(Error::<T, I>::InvalidIndex)?;
					...
					pezpallet_treasury::Error::<T, I>::InsufficientPermission
				);
...
impl<T: Config<I>, I: 'static> Pezpallet<T, I> {
	...
	fn try_state_bounties_count() -> Result<(), pezsp_runtime::TryRuntimeError> {
...
impl<T: Config<I>, I: 'static> Pezpallet<T, I> {
	...
	pub fn treasury_block_number() -> BlockNumberFor<T, I> {
		<T as pezpallet_treasury::Config<I>>::BlockNumberProvider::current_block_number()
	}
