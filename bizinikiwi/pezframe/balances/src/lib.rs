...
//! - [`ReservableCurrency`]
//! - [`NamedReservableCurrency`](pezframe_support::traits::NamedReservableCurrency):
//! Functions for dealing with assets that can be reserved from an account.
//! - [`LockableCurrency`](pezframe_support::traits::LockableCurrency): Functions for
//! dealing with accounts that allow liquidity restrictions.
//! - [`Imbalance`](pezframe_support::traits::Imbalance): Functions for handling
...
//! #   stash: <T as pezframe_system::Config>::AccountId,
//! #   total: <<T as Config>::Currency as pezframe_support::traits::Currency<<T as pezframe_system::Config>::AccountId>>::Balance,
...
pub mod pezpallet {
	...
	///    type AccountStore = StorageMapShim<Self::Account<Runtime>, pezframe_system::Provider<Runtime>, AccountId, Self::AccountData<Balance>>
	///  }
	/// ```
	///
