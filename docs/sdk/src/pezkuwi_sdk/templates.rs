...
//!
//! - [`minimal-template`](https://github.com/pezkuwichain/pezkuwi-DKS/issues/195): A minimal
//!   template that contains the least amount of features to be a functioning blockchain. Suitable
//!   for learning and testing.
//! - [`solochain-template`](https://github.com/pezkuwichain/pezkuwi-DKS/issues/195): Formerly known
...
//!
//! Note that these templates are mirrored automatically from [this](https://github.com/pezkuwichain/pezkuwi-DKS/blob/master/templates)
